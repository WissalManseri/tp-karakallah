...
public class Calculator {
	...
	private void initialize() {
		...
		btnCE.setForeground(Color.DARK_GRAY);
		...
		btnAddM.setBackground(Color.DARK_GRAY);
		...
		btnPoint.setBackground(Color.DARK_GRAY);
		...
		btnNewButton_15_3.setForeground(Color.WHITE);
		...
		btnNewButton_15_3.setBackground(Color.DARK_GRAY);
